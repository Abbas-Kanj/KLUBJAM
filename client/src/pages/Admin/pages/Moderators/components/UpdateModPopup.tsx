...
interface UpdateModProps {
  setopenUpdateModPopup: (open: boolean) => void;
}

const UpdateModPopup: React.FC<UpdateModProps> = ({
  setopenUpdateModPopup,
}) => {
  return (
      ...
      <form className="flex flex-col w-[1000px] h-[650px] rounded-xl bg-background">
        <div className="flex justify-between ">
          <p
            ...
            onClick={() => setopenUpdateModPopup(false)}
          >
            X
          </p>
