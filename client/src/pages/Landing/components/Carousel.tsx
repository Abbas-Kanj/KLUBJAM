    ...
    <Slider {...settings}>
      <div className="flex flex-col text-center items-center mx-auto w-[1132px] h-[400px] mt-[282px] bg-backgroundPurple bg-opacity-20 pt-[40px] pb-[40px] pr-[70px] pl-[70px] relative z-20">
        ...
        <p className="text-[26px] font-bold mt-[21px] mb-[21px]">
          ...
          individuals on music projects. The platform provides easy-to-use tools
          for uploading tracks, <br /> collaborating in real-time, and managing
      ...
      <div className="flex flex-col text-center items-center mx-auto w-[1132px] h-[400px] mt-[282px] bg-backgroundPurple bg-opacity-20 pt-[40px] pb-[40px] pr-[70px] pl-[70px] relative z-20">
        <img src={reviewerImg2} alt="" className="w-[96px] h-[96px] mx-auto" />
        <p className="text-[26px] font-bold mt-[21px] mb-[21px]">
      ...
      <div className="flex flex-col text-center items-center mx-auto w-[1132px] h-[400px] mt-[282px] bg-backgroundPurple bg-opacity-20 pt-[40px] pb-[40px] pr-[70px] pl-[70px] relative z-20">
        <img src={reviewerImg3} alt="" className="w-[96px] h-[96px] mx-auto" />
        <p className="text-[26px] font-bold mt-[21px] mb-[21px]">
          “As a music enthusiast, I've found this platform to be a game-changer.
          The ability to collaborate with like-minded individuals has opened up
          new possibilities for my music. The tools provided are top-notch and
